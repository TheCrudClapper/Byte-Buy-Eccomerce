...
public class PublicCountriesHttpClient(HttpClient httpClient, IOptions<ApiEndpointsOptions> options)
    : HttpClientBase(httpClient, options), IPublicCountriesHttpClient
{
    private readonly string resource = options.Value.CountriesOptions;
