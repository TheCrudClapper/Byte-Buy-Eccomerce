namespace ByteBuy.Infrastructure.Options;
...
public class ApiEndpointsOptions
{
    ...
    public string CompanyItems { get; set; } = default!;
    public string Company { get; set; } = default!;
    public string CompanyPortalUsers { get; set; } = default!;
    public string CompanyRentOffers { get; set; } = default!;
    public string CompanyRoles { get; set; } = default!;
    public string CompanySalesOffers { get; set; } = default!;
