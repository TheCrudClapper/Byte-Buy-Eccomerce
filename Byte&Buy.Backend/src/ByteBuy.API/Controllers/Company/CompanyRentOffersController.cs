...
public class CompanyRentOffersController : BaseApiController
{
    ...
    [HttpPost]
    [HasPermission("company-rent-offers:create:one")]
    ...
    [HttpPut("{id:guid}")]
    [HasPermission("company-rent-offers:update:one")]
    ...
    [HttpDelete("{id:guid}")]
    [HasPermission("company-rent-offers:delete:one")]
    public async Task<IActionResult> DeleteAsync(Guid id)
        => HandleResult(await _rentOfferService.DeleteAsync(id));

    [HttpGet("{id:guid}")]
    [HasPermission("company-rent-offers:read:one")]
    ...
    [HttpGet("list")]
    [HasPermission("company-rent-offers:read:many")]
